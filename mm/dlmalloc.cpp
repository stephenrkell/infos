...
#include <infos/util/string.h>      /* for memset etc */
...
static void** ialloc(mstate m,
  ...
  */
  ...
  if (opts & 0x2) {       /* optionally clear the elements */
    infos::util::memset((size_t*)mem, 0, remainder_size - SIZE_T_SIZE - array_size);
  }
    ...
    if (!PREACTION(m)) {
      ...
      if (newp != 0) {
        ...
        if (mem != 0) {
          ...
          infos::util::memcpy(mem, oldmem, (oc < bytes)? oc : bytes);
